  ...
  return (
    <div className=" bg-bgPrimary h-full">
      <div className=" container mx-auto">
        ...
        <div className="flex justify-center text-white items-center gap-x-20 mt-10">
          <div>
            <p className="text-[20px] font-normal font-merriweatherSans">
              Upload your property in 4 simple <br /> steps
            </p>
            {Array.from({ length: 5 }).map((item, index) => (
              <div className="flex gap-x-2 mt-4 text-white ml-2">
          ...
          <div className="bg-white rounded-lg w-[600px] text-black ">
            <div className=" bg-[#FCF8F4] py-2  rounded-t-lg ">
            ...
            <div className="flex justify-between items-center p-2 mt-5 rounded-b-lg bg-[#FCF8F4]">
              ...
              <button
                ...
                className="bg-gray-700 py-1 px-6 text-white rounded-md"
              >
